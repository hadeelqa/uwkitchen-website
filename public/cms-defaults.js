...
window.CMS_DEFAULTS = {
  ...
  /* ───────── Announcement bar ───────── */
  announce: {
    text:  'عرض شهر مايو: 30%',
    text2: 'عملاء الموقع كود خصم 1200ريال: UW12'
  },
  ...
  hero: {
    ...
    promise1: 'ضمان 15 سنة شامل',
    promise2: 'على كل قطعة من مطبخك بعقدٍ رسمي من مصانعنا',
  ...
  stats: {
    items: [
      { num: '4.9',     label: 'تقييم عملائنا' },
      { num: '+17,500', label: 'مطبخ منفّذ' },
      { num: '25',      label: 'قطاع' },
      { num: '7',       label: 'مدن' },
      { num: '20',      label: 'يوم فقط' }
    ]
  },
  ...
  testimonials: {
    items: [
      { name: 'أبو عبدالله',       initials: 'أ', quote: 'من أفضل الشركات اللي تعاملت معهم. التصميم طلع أحلى من اللي تخيلته والتركيب كان سريع واحترافي جدا' },
